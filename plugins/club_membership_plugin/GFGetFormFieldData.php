 ...
 *
 ***************************************************
 * Get all form field data and return it in an array
 * http://kaptkaos.com/wordpress/examples
 **************************************************/

namespace club_membership_plugin;

class GFGetFormFieldData {
...
new GFGetFormFieldData(115, array(
	5 => array(
		'min' => 2,
		'max' => 3
	),
